...
namespace SiyayaTravelAssist.Controllers
{
    public class ProvinceController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProvinceID,ProvinceDescription")] Province province)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProvinceID,ProvinceDescription")] Province province)
        {
            if (ModelState.IsValid)
            {
