...
namespace SiyayaTravelAssist.Controllers
{
    public class VehicleTypeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "VehicleTypeID,VehicleTypeDescription")] VehicleType vehicleType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VehicleTypeID,VehicleTypeDescription")] VehicleType vehicleType)
        {
            if (ModelState.IsValid)
            {
