...
namespace SiyayaTravelAssist.Controllers
{
    public class TitleController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TitleID,TitleDescription")] Title title)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TitleID,TitleDescription")] Title title)
        {
            if (ModelState.IsValid)
            {
