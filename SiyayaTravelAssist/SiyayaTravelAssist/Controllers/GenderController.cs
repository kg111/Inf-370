...
namespace SiyayaTravelAssist.Controllers
{
    public class GenderController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GenderID,GenderDescription")] Gender gender)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GenderID,GenderDescription")] Gender gender)
        {
            if (ModelState.IsValid)
            {
