...
namespace SiyayaTravelAssist.Controllers
{
    public class PassengerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PassengerID,PassengerDescription")] Passenger passenger)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PassengerID,PassengerDescription")] Passenger passenger)
        {
            if (ModelState.IsValid)
            {
