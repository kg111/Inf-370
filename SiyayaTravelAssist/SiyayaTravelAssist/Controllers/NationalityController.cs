...
namespace SiyayaTravelAssist.Controllers
{
    public class NationalityController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NationalityID,NationalityDescription")] Nationality nationality)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NationalityID,NationalityDescription")] Nationality nationality)
        {
            if (ModelState.IsValid)
            {
